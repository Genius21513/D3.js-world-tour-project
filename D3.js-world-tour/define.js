...
export default function define(runtime, observer) {
  ...
  main.variable(observer("m_title")).define(["md"], _1);  
  main.variable(observer("m_country")).define(["html", "name"], _2);
  main.variable(observer("m_globe")).define("canvas", ["DOM", "width", "height", "d3", "sphere", "land", "borders", "countries", "mutable name", "tilt", "Versor"], _canvas);
